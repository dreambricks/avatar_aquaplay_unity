...
public class LogUtil : MonoBehaviour
{
    ...
    public static void SendLogCSV(DataLog dataLog)
    {
        ...
        if (!File.Exists(logFilePath))
        {
            ...
            {
                writer.WriteLine("timePlayed,status,score,nation"); // Adicione os cabeçalhos necessários aqui
            }
        }
        ...
        string csvLine = string.Format("{0},{1},{2},{3}", dataLog.timePlayed, dataLog.status, dataLog.score, dataLog.nation); // Adapte conforme sua classe DataLog
